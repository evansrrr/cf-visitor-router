...
Paste one of the js script in your Cloudflare Worker and config your route rules.

If you don't know which site is better served in that country or region, you can check [WebpageTest](https://webpagetest.org).

Bind your custom domain to the Worker in the Cloudflare Dashboard. Proxied mode is recommended.
